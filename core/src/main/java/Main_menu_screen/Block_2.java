...
public class Block_2 extends Block_obstacle {
    public Block_2(World world, Vector2 position, float width, float height) {
        super(world, position, width, height);
        texture = new Texture("wood_block_vertical.png");
    }
