...
public class LevelState2 implements Serializable {
    ...
    public LevelState2(level_2 level) {
    ...
    // Load method
    public static LevelState2 loadFromFile(String filename) {
        try (FileInputStream fileIn = new FileInputStream(filename);
             ObjectInputStream in = new ObjectInputStream(fileIn)) {
            return (LevelState2) in.readObject();
        }
    ...
    public void restoreState(level_2 level) {
